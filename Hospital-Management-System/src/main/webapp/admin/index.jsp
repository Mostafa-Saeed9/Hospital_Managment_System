...
<body>
	...
	<div class="container p-5">
		...
		<c:if test="${not empty SSMsg }">
			<p class="text-center text-danger fs-5">${SSMsg}</p>
			<c:remove var="SSMsg" scope="session" />
		</c:if>

		<c:if test="${not empty ESMsg }">
			<p class="text-center text-danger fs-5">${ESMsg}</p>
				...
				<div class="card paint-card">
					<div class="card-body text-center text-success">
						...
						<p class="fs-4 text-center">
							Number of Doctors <br><%=dao.countDoctor() %>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4 mt-2">
				...
				<div class="card paint-card " data-bs-toggle="modal"
					...
					<div class="card-body text-center text-success">
						<i class="far fa-calendar-check fa-3x"></i><br>
						<p class="fs-4 text-center">
							Total specialties <br><%=dao.countSpecialist() %>
						</p>
					</div>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title text-success" id="exampleModalLabel" > Adding Specialist </h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<form action="../addSpecialiest" method="post">
						<div class="form-group">
							<label> Enter Specialiest Name</label> <input type="text"
